...
namespace Subscription {
    ...
    void GroupUpdater::ImportUrl(const QString &url, const Finish &finish) {
        ...
        enqueue({-1, false, [=, this] {
            ...
            if (fetch(content, content, ResolveIdentity(nullptr), body, userInfo, policyJson)) {
    ...
    bool GroupUpdater::fetch(const QString &url, const QString &name, const RequestIdentity &identity,
                             QByteArray &body, QString &userInfo, QString &policyJson) {
